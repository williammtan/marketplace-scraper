...
from web_scraping_food import ingest_tokopedia_link, ingest_tokopedia_desc, ingest_tokopedia, ingest_bukalapak, ingest_shopee_full
...
parser.add_argument('--ingest_bukalapak', action='store_true', help='ingest bukalapak')
